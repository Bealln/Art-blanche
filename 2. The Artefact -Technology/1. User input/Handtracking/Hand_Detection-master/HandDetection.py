...
while(1):
    ...
    #LOOK INTO THIS - need to export as two values with a coma in the middle
    with open('hand_position.txt', 'w') as filehandle:  
        #json.dump(positions, filehandle)
        json.dump(cx, filehandle)
        json.dump(cy, filehandle)
